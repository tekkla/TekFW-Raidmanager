...
$txt['app_raidmanager_cfg_topic_board_desc'] = 'Das Board, in dem das Raidtopic erstellt werden soll. Wenn das gewünschte Board noch nich existiert, dann <a href="' . $scripturl .'?action=admin;area=manageboards;sa=mainhier anlegen</ und die Konfiguration erneut aufrufen.';
